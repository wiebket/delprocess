...
1. From [Data First](https://datafirst.uct.ac.za/) at the University of Cape Town (UCT). On site access to the complete 5 minute data is available through their secure server room.   
...
3. Several datasets with aggregated views are available [online](https://www.datafirst.uct.ac.za/dataportal/index.php/catalog/NRSLR/about) and can be accessed for academic purposes. If you use them, you will *not* need to install this package. 
